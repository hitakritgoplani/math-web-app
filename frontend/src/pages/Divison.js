...
export default function Divison() {
    ...
    async function handleEnterPressed(inputValue) {
        if (inputValue) {
            if (Number(question1 / question2) === Number(inputValue)) {
                correct = true;
        ...
        <div>
            ...
            <div className='add-root'>
                <div style={{ backgroundColor: "#fff" }} className='add-question'>
                    ...
                    <div style={{ width: "10vw", textAlign: "center", color: "#c8c8c8", textShadow: "black 5px 5px", height: "inherit", fontSize: "15vw" }}><strong>&#247;</strong></div>
